<% @  Control Language="c#" Inherits="PageAdmin.mem_fmlst" %>
<div class="uc_lanmu_box">
<div class="uc_lanmu_site">
<ul>
<li class="uc_lanmu_site_1">当前位置：首页 &gt; <a href="/member/index.aspx?language=<%=Request.QueryString["language"]%>">会员中心</a> &gt; <%=FName%></li>
<li class="uc_lanmu_site_2"><%=FName%></li>
</ul>
</div>
...
<asp:PlaceHolder  id="P_Add" runat="server" Visible="false" >
 <table border="0" cellspacing="0" cellpadding="0" width="98%" align="center">
    <tr><td align=right height=25px>
      <input type="button" class='m_bt' value="我要发布" onclick="location.href='<%=Get_Url("mem_fmadd")%>'">
    </td></tr>
   </table> 
</asp:PlaceHolder>
 <table border="0" cellspacing="0" cellpadding="0" class="member_table">
    <tr>
...
<asp:Repeater id="P1" runat="server" OnItemDataBound="P1_Bound">     
 <ItemTemplate>
      ...
      <td align=center  class="memlist_item_last">
        <asp:HyperLink Text="查看"   id="Edit" runat="server" NavigateUrl='<%#Get_Url("mem_fmdtl",DataBinder.Eval(Container.DataItem,"id").ToString())%>' />
