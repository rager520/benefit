<% @  Control Language="c#" Inherits="PageAdmin.mem_articleadd" %>
<div class="uc_lanmu_box">
<div class="uc_lanmu_site">
<ul>
<li class="uc_lanmu_site_1">当前位置：首页 &gt; <a href="/member/index.aspx?language=<%=Request.QueryString["language"]%>">会员中心</a> &gt; 发布文章</li>
<li class="uc_lanmu_site_2">发布文章</li>
</ul>
</div>
<div class="uc_lanmu_content">
<form  name="form1" method='post'  Enctype='multipart/form-data'>

<table border=1 cellpadding=5px cellspacing=0  align=center  class="member_table">
<tr>
...
<input type="hidden" id="Sort_1_text" name="Sort_1_text"><input type="hidden" id="Sort_2_text" name="Sort_2_text">
      ...
      <tr>
          <td  height=25>标题 <span style="color:#ff0000">*</span></td>
          <td><input type="textbox"  Name="TBtitle" id="TBtitle" Maxlength="100"  size=60 class="tb">
        </td>
      </tr>

      <tr>
          <td width=100px height=25 >作者</td>
          <td><input type="textbox" name="TBAuthor" id="TBAuthor"  Maxlength="100"  size=30 class="tb">
...
【<span  onclick="document.getElementById('TBAuthor').value=this.innerHTML" style="cursor:pointer;color:#666666">不详</span>】
      ...
      <tr>
          ...
          <td><input type="textbox" name="TBSource" id="TBSource" Maxlength="100"  size=30 class="tb">
【<span  onclick="document.getElementById('TBSource').value=this.innerHTML" style="cursor:pointer;color:#666666">本站</span>】
      ...
      <tr style="display:<%=Upload_Show%>">
          ...
          <td><input type="file" name="UploadFile"  size=40 class="tb"></td>
      </tr>
      ...
      <tr>
          ...
          <td><input type="textbox" name="TBkeywords" Maxlength="100"  size=60 class="tb">
        </td>
      </tr>

      <tr>
          <td width=100px height=25 >seo描述(200字以内)</td>
          <td><Textarea name="TBdescription"  Cols="55"  rows="5" onkeyup="if(this.value.length>200){this.value=this.value.substring(0,200)}" class="tb"></Textarea>
        </td>
      </tr>
   ...
   <tr>
          <td>文章简介</td>
          <td>
<Textarea type="textbox" id="Introduct" name="Introduct" ></Textarea>
...
<input type="submit" id="submit" value="提交"   class="bt" onclick="return Check_Information_Form()">&nbsp;&nbsp;
