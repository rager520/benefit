<% @  Control Language="c#" Inherits="PageAdmin.mem_articlelst" %>
<div class="uc_lanmu_box">
<div class="uc_lanmu_site">
<ul>
<li class="uc_lanmu_site_1">当前位置：首页 &gt; <a href="/member/index.aspx?language=<%=Request.QueryString["language"]%>">会员中心</a> &gt; 文章管理</li>
<li class="uc_lanmu_site_2">文章管理</li>
</ul>
</div>
...
<asp:PlaceHolder  id="P_Add" runat="server" Visible="false" >
 <table border="0" cellspacing="0" cellpadding="0" width="98%" align="center">
    <tr><td align=right height=25px>
      <input type="button" class='m_bt' value="发布文章" onclick="location.href='<%=Get_Url("mem_articleadd")%>'">
    </td></tr>
   </table> 
</asp:PlaceHolder>
 ...
 <table border="0" cellspacing="0" cellpadding="0"  align="center" class="member_table">
    <tr>
      <td align=center  class="memlist_header_item" width="60%">标题</td> 
...
<asp:Repeater id="P1" runat="server" OnItemDataBound="P1_Bound">      
 <ItemTemplate>
      ...
      <td align=left class="memlist_item"><%#Get_Image(DataBinder.Eval(Container.DataItem,"upload").ToString())%><a href="<%#Get_ArticleUrl(DataBinder.Eval(Container.DataItem,"id").ToString(),DataBinder.Eval(Container.DataItem,"lanmu1id").ToString(),DataBinder.Eval(Container.DataItem,"lanmu3id").ToString(),DataBinder.Eval(Container.DataItem,"planguage").ToString())%>" target=_blank><%#Server.HtmlEncode(DataBinder.Eval(Container.DataItem,"title").ToString())%></a></td> 
      ...
      <td align=center  class="memlist_item_last">
        <asp:HyperLink Text="查看"   id="Edit" runat="server" NavigateUrl='<%#Get_Url("mem_articledtl",DataBinder.Eval(Container.DataItem,"id").ToString())%>' />
...
<tr>
  <td  height=25>分类显示：<asp:DropDownList id="Dl_Infor1" runat="server" DataTextField="sort_name" DataValueField="id"  AutoPostBack="true" OnSelectedIndexChanged="Infor2_Bind" />
