<% @ Page Language="C#" Inherits="PageAdmin.zdyform_sort_2" %>
...
<a href="memberpublish_set.aspx?id=<%#DataBinder.Eval(Container.DataItem,"id")%>&table=zdyform_sort&type1=<%#Server.UrlEncode(Request.QueryString["sort1_name"])%>&type2=<%#Server.UrlEncode(DataBinder.Eval(Container.DataItem,"sort_name").ToString())%>&backurl=<%#Server.UrlEncode(Request.RawUrl)%>">会员发布设置<a>
...
<br>
        <div align=center>
          ...
          <input  type="button" onclick="location.href='zdyform_sort_1.aspx?fid=<%=F_Id%>&ftable=<%=F_Table%>'" Class="button"  value="返回"/>
       </div>
       </td>
    </tr>
   </table>
