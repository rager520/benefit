<% @ Page Language="C#" Inherits="PageAdmin.template_style" %>
...
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 ...
 <tr><td class=table_style1><b>模块自定义样式</b></td></tr>
 <tr><td height=10></td></tr>
</table>
...
<tr>
  <td  colspan=2 height=25><b>模块自定义样式管理</b></td>
 </tr>
</table>
             ...
             <ItemTemplate>
                ...
                <tr>
                  ...
                  <td align=center width=20% class=tdstyle>
                   ...
                   <a href="template_style_set.aspx?id=<%#DataBinder.Eval(Container.DataItem,"id")%>&name=<%#Server.UrlEncode(DataBinder.Eval(Container.DataItem,"name").ToString())%>">样式设置</a>
...
<tr>
  <td valign=top>
    ...
    <tr><td  colspan=3 height=25><b>增加新样式</b></td>
      ...
      <tr>
        <td  height=25>模块样式名称：<asp:TextBox      id="Add_Name"     maxlength=40 size=20  runat="server" />
