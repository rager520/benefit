<% @ Page Language="C#" Inherits="PageAdmin.vote_1" %>
<% @ Register TagPrefix="aspcn" TagName="uc_head" src="head.ascx" %>
<aspcn:uc_head runat="server" Type="js_4" />
<body topmargin=0 bottommargin=0 leftmargin=0  rightmargin=0>
<center>
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 <tr><td height=10></td></tr>
 <tr><td class=table_style1 align="left"><b>问卷调查调用</b></td></tr>
 <tr><td height=10></td></tr>
</table>
...
<tr>
  <td  colspan=2 height=25  align="left"><b>问卷调查调用管理</b></td>
 </tr>
</table>
                ...
                <tr>
                  ...
                  <td align=center width=25%  class=tdstyle>
                    <asp:DropDownList id="Dl_Style" runat="server">
                      ...
                      <asp:ListItem Value="1" style="color:#ff0000">多选框</asp:ListItem>
                    </asp:DropDownList>
                   </td>
                  ...
                  <td align=center width=35% class=tdstyle>
                   ...
                   <a href="vote_2.aspx?id=<%#DataBinder.Eval(Container.DataItem,"id")%>&name=<%#Server.UrlEncode(DataBinder.Eval(Container.DataItem,"name").ToString())%>">问卷设置</a>
                    <a href="javascript:slide_Js_Code('<%#DataBinder.Eval(Container.DataItem,"id")%>','0','vote')">生成JS代码</a>
...
<tr>
  <td valign=top>
    <table border=0 cellpadding=0 cellspacing=2 width=95% align=center>
    <tr><td  colspan=3 height=25><b>增加问卷调查调用</b></td>
    </tr>
      <tr>
        <td  height=25 align="left">问卷名称：<asp:TextBox      id="Add_Name"    maxlength="45"  size=20  runat="server" />
