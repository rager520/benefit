<% @ Page Language="C#"  Inherits="PageAdmin.product_2"%>
<% @ Register TagPrefix="aspcn" TagName="uc_head" src="head.ascx" %>
<aspcn:uc_head runat="server" Type="product_3" />
<body topmargin=0 bottommargin=0 leftmargin=0  rightmargin=0>
<center>
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 <tr><td height=10></td></tr>
 <tr><td class=table_style1><b>发布产品</b></td></tr>
 <tr><td height=10></td></tr>
</table>
...
<input type="hidden" id="Sort_1_text" name="Sort_1_text"><input type="hidden" id="Sort_2_text" name="Sort_2_text">
      ...
      <tr>
          ...
          <td><input type="text" name="TBname" id="TBname"  Maxlength=50 size=40></td>
      </tr>
      <tr>
          <td  height=25 >产品型号</td>
          <td ><input type="text" name="TBxinghao" Maxlength=40 size=40  ></td>
      </tr>
</tr>  
     ...
     <tr>
          <td>产品价格</td>
          <td><input type="text" name="TBprice" Maxlength=10 size=10 value="0" onkeyup="if(isNaN(value))execCommand('undo')" title="产品标价"> 单位：<input type="text" name="TBunit"  Maxlength=15 size=6 value="<%=Unit%>">
  ...
  <asp:Repeater id="P1" runat="server">
     ...
     <tr title="<%#DataBinder.Eval(Container.DataItem,"m_type")%>价格">
      <td>
        ...
        <input type="text" name="TBMprice"  Maxlength=10 size=10 value="0" onkeyup="if(isNaN(value))execCommand('undo')"> <%#DataBinder.Eval(Container.DataItem,"m_type")%>
     </td>
     </tr>
     </ItemTemplate>
    </asp:Repeater>
...
<tr>
  ...
  <select name="Dl_Watermark" id="Watermark">
   ...
   </select><input type="file"  size=40  name="Upload" id="Upload" >
  ...
  <td>
   ...
   <select name="Dl_Comments_Style">
     ...
     <tr>
          <td>产品简介</td>
          <td>
            <textarea name="TBIntroduct" id="TBIntroduct"></textarea>
...
<input type="submit" value=" 发 布 "     class="button" onclick="return Check_Product_Form(1)">
<input type="button" value=" 返 回 "    class="button" onclick="location.href='product_1.aspx'"/>
</td>
      <tr>       
    </table>
 </td>
