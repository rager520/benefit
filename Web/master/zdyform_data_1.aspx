<% @ Page Language="C#" Inherits="PageAdmin.zdyform_data_1"  %>
...
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 ...
 <tr><td class=table_style1><b>增加数据</b></td></tr>
 <tr><td height=10></td></tr>
</table>
...
<td><input type=text name='Head_Title' Maxlength='150'  size='80'></td>
</tr>


<tr>
<td align=left width='100px'>SEO关键字</td>
<td><input type=text name='KeyWords' Maxlength='150'  size='80'></td>
</tr>

<tr>
<td align=left width='100px'>SEO描述</td>
<td><TextArea name='Description' cols='65'  rows='5'></TextArea></td>
</tr>


<tr><td align=left width='100px'>其他设置</td>
<td><select name='Comments_Style' id='Dl_Comments_Style'>
<option value=''>==评论功能设置==</option>
<option value='0'>评论关闭</option>
<option value='1'>评论开启(需要审核)</option>
<option value='2'>评论开启(直接显示)</option></select>(不选择则默认子栏目中的设置)</td>
</tr>
</table>
</div>
<div align=center>
<input type='submit'  class='button' value='提交' onclick="return Check_ZdyForm('<%=Form_Table%>','<%=P_language%>')"> 
<input type='button' value='返回' class='button' onclick="location.href='zdyform_data.aspx?fid=<%=FormId%>&ftable=<%=Form_Table%>&fname=<%=Server.UrlEncode(Form_Name)%>'"></td>
</div>
</form>
</td>
</tr>
