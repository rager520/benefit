<% @ Page Language="C#" Inherits="PageAdmin.lanmu_2_article" %>
...
<tr>
  ...
  <td><asp:DropDownList id="Article_show_tj" runat="server">
   ...
   </asp:DropDownList> 注：仅对第一种显示样式有效
...
<tr>
  ...
  <td title="汉字占用2个字节"><asp:TextBox id="Article_title_num" runat="server" Value="26" Maxlength=3 size=5/> 个字符 
<asp:RangeValidator   ControlToValidate="Article_title_num" display="Static" type="integer" MinimumValue="0" MaximumValue="200" runat="server">
请输入0—200之间的数字</asp:RangeValidator></td>
 </tr>
<tr>
  <td  height=25>文章显示数</td>
  <td><asp:TextBox id="Article_show_num" runat="server" Value="5" Maxlength="3" size=5/> 条记录
<asp:RangeValidator   ControlToValidate="Article_show_num" display="Static" type="integer" MinimumValue="1" MaximumValue="50" runat="server">
