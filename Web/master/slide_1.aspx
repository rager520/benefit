<% @ Page Language="C#" Inherits="PageAdmin.slide_1" %>
<% @ Register TagPrefix="aspcn" TagName="uc_head" src="head.ascx" %>
<aspcn:uc_head runat="server" Type="js_2" />
...
<tr>
  <td  colspan=2 height=25><b>幻灯片调用管理</b></td>
 </tr>
</table>
          ...
          OnItemDataBound="PageAdmin_Data_Bound"    OnDeleteCommand="PageAdmin_Data_Delete" >
             <HeaderTemplate>
                ...
                <tr>
                  ...
                  <td align=center width=25% class=white>类 型</td>
             ...
             <ItemTemplate>
                ...
                <tr>
                  <td align=center width=25%  class=tdstyle>
                    <asp:TextBox  id="Tb_name"  maxlength="50"  Text='<%#DataBinder.Eval(Container.DataItem,"name")%>' runat="server" /></td>

                  <td align=center width=25%  class=tdstyle>
                    <asp:DropDownList id="Dl_Style" runat="server">
                      <asp:ListItem Value="0">js幻灯片</asp:ListItem>
                      <asp:ListItem Value="1" style="color:#0099FF">js幻灯片(带数字)</asp:ListItem>
                      <asp:ListItem Value="2" style="color:#ff0000">Flash幻灯片</asp:ListItem>
                    </asp:DropDownList>
                   </td>
                  ...
                  <td align=center width=35% class=tdstyle>
                   ...
                   <a href="slide_2.aspx?id=<%#DataBinder.Eval(Container.DataItem,"id")%>&name=<%#Server.UrlEncode(DataBinder.Eval(Container.DataItem,"name").ToString())%>">参数设置</a>
                    <a href="javascript:slide_Js_Code('<%#DataBinder.Eval(Container.DataItem,"id")%>','0','slide')">生成JS代码</a>
    ...
    <tr><td  colspan=3 height=25><b>增加幻灯片调用</b></td>
      ...
      <tr>
        <td  height=25>幻灯片名称：<asp:TextBox      id="Add_Name"     maxlength=40 size=20  runat="server" />
                     幻灯片类型：<asp:DropDownList id="Add_Style" runat="server">
                      <asp:ListItem Value="0">js幻灯片</asp:ListItem>
                      <asp:ListItem Value="1" style="color:#0099FF">js幻灯片(带数字)</asp:ListItem>
                      <asp:ListItem Value="2" style="color:#ff0000">Flash幻灯片</asp:ListItem>
                    </asp:DropDownList>
