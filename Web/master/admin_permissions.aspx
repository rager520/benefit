...
<table border=0 cellpadding=0 cellspacing=2 width=95% align=center>
 ...
 <tr>
  ...
  <td align="left" height=25>
   ...
   <input type="checkbox" id="basic_3" name="basic" value="basic_3">在线支付接口&nbsp;
   <input type="checkbox" id="basic_4" name="basic" value="basic_4">站内广告管理&nbsp;
   <input type="checkbox" id="basic_5" name="basic" value="basic_5">网站流量统计
...
<tr>
  ...
  <td align="left" height=25>
   ...
   <input type="checkbox" id="business_4" name="business" value="business_4">留言管理&nbsp;
 </td>
 </tr>
...
<tr>
  ...
  <td align="left" height=25>
   ...
   <input type="checkbox" id="product_4" name="product" value="product_4">产品评论管理&nbsp;
 </td>
 </tr>
...
<tr>
  ...
  <td align="left" height=25>
   ...
   <input type="checkbox" id="article_4" name="article" value="article_4">文章评论管理&nbsp;
 </td>
 </tr>
...
<input type="button" value="返 回"     class="button" onclick="location.href='member_1.aspx?tid=<%=Request.QueryString["m_type"]%>&group=admin'" />
</td>
</tr>
</table>
</td>
