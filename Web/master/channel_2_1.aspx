<% @ Page Language="C#" Inherits="PageAdmin.channel_2_1" %>
...
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 ...
 <tr><td class=table_style1><b>编辑网点</b></td></tr>
</table>
...
<aspcn:uc_fckeditor  Tb_Id="Content" Fck_Height="400" Fck_Style="Basic" runat="server"/>
      ...
      <tr >
        <td height=25  align=left>序号</td><td><asp:TextBox id="Xuhao" Text="0" Maxlength="5" size="5" runat="server" />
