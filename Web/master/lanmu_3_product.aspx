<% @ Page Language="C#" Inherits="PageAdmin.lanmu_3_product" %>
...
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 ...
 <tr><td class=table_style1><b>产品展示设置</b></td></tr>
 <tr><td height=10></td></tr>
</table>
...
<asp:CompareValidator Id="cv1" ControlToValidate="Dl_Prod1" ValueToCompare="0" display="Dynamic" type="Integer"  runat="server">
请选择产品类别</asp:CompareValidator>
...
<tr>
  <td  height=25>产品排列样式</td>
  <td><asp:DropDownList id="Dl_show_style" runat="server">
     <asp:ListItem value="0">产品图片+产品名称</asp:ListItem>
     <asp:ListItem value="1">产品图片+产品名称+简介</asp:ListItem>
   </asp:DropDownList></td>
 </tr>
...
<tr>
  <td  height=25>产品介绍样式</td>
  <td><asp:DropDownList id="Product_info_style" runat="server">
     <asp:ListItem value="0">显示所有参数</asp:ListItem>
     <asp:ListItem value="1">仅显示产品介绍</asp:ListItem>
   </asp:DropDownList></td>
 </tr>
...
<tr>
  <td  height=25>名称显示字数</td>
  <td title="汉字占用2个字节"><asp:TextBox id="Tb_name_num" runat="server" Maxlength=3 size=5/> 个字符 
 <asp:RequiredFieldValidator   ControlToValidate="Tb_name_num" display="Dynamic" type="integer"  runat="server">
显示字数不能为空</asp:RequiredFieldValidator>
<asp:RangeValidator   ControlToValidate="Tb_name_num" display="Static" type="integer" MinimumValue="1" MaximumValue="200" runat="server">
请输入1—200之间的数字</asp:RangeValidator></td>
 </tr>
<tr>
  <td  height=25>每页显示</td>
  <td><asp:TextBox id="Tb_show_num" runat="server"  Maxlength=3 size=5 /> 条记录
<asp:RequiredFieldValidator   ControlToValidate="Tb_show_num" display="Dynamic" type="integer"  runat="server">
不能为空</asp:RequiredFieldValidator>
<asp:RangeValidator   ControlToValidate="Tb_show_num" display="Static" type="integer" MinimumValue="1" MaximumValue="100" runat="server">
请输入1—100之间的数字</asp:RangeValidator></td>
 </tr>
<tr>
  <td  height=25 style="color:#ff0000">每行显示</td>
  <td><asp:TextBox id="Tb_columns" runat="server" Maxlength=3 size=5/> 条记录
<asp:RequiredFieldValidator   ControlToValidate="Tb_columns" display="Dynamic" type="integer"  runat="server">
不能为空</asp:RequiredFieldValidator>
<asp:RangeValidator   ControlToValidate="Tb_columns" display="Static" type="integer" MinimumValue="1" MaximumValue="10" runat="server">
请输入1—10之间的数字</asp:RangeValidator></td>
 </tr>
<tr>
  <td  height=25>在线订购</td>
  <td><asp:DropDownList id="Dl_order" runat="server">
