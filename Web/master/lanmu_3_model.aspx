<% @ Page Language="C#" Inherits="PageAdmin.lanmu_3_model" %>
...
<tr>
  <td  height=30>每页显示</td>
  <td><asp:TextBox id="Model_show_num" runat="server"  Maxlength="3" size="5" /> 条数据
<asp:RequiredFieldValidator   ControlToValidate="Model_show_num" display="Dynamic" type="integer"  runat="server">
不能为空</asp:RequiredFieldValidator>
<asp:RangeValidator   ControlToValidate="Model_show_num" display="Static" type="integer" MinimumValue="1" MaximumValue="100" runat="server">
