<% @ Page Language="C#" Inherits="PageAdmin.hr_2" %>
<% @ Register TagPrefix="aspcn" TagName="uc_head" src="head.ascx" %>
<aspcn:uc_head runat="server" Type="hr_2" />
<body topmargin=0 bottommargin=0 leftmargin=0  rightmargin=0>
<center>
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 <tr><td height=10></td></tr>
 <tr><td class=table_style1><b>招聘发布</b></td></tr>
 <tr><td height=10></td></tr>
</table>
...
<tr>
  <td  colspan=2 height=25px><b>招聘发布</b></td>
 </tr>
 <tr>
...
<asp:Button class=button   text="提交"  runat="server" onclick="PageAdmin_Data_Add" />
<input type="button" value="关闭"     class="button" onclick="location.href='hr_1.aspx'" />
</td>
 </tr>
</table>
