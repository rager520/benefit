<% @ Page Language="C#" Inherits="PageAdmin.link_1" %>
<% @ Register TagPrefix="aspcn" TagName="uc_head" src="head.ascx" %>
<aspcn:uc_head runat="server"  Type="js_5" /> 
...
<tr>
  <td  colspan=2 height=25><b>链接调用管理</b></td>
 </tr>
</table>
        ...
        <td  colspan=2 height=25>
          ...
          OnItemDataBound="PageAdmin_Data_Bound"    OnDeleteCommand="PageAdmin_Data_Delete" >
             <HeaderTemplate>
                ...
                <tr>
                  <td align=center width=25% class=white height=25px>链接类型</td>
                  <td align=center width=25% class=white>目标窗口</td>
             ...
             <ItemTemplate>
                ...
                <tr>
                  <td align=center width=25%  class=tdstyle>
                    <asp:TextBox  id="Tb_type"  Text='<%#DataBinder.Eval(Container.DataItem,"link1")%>' runat="server" /></td>
                  <td align=center width=25%  class=tdstyle>
                    <asp:DropDownList id="Dl_target" runat="server">
                      <asp:ListItem Value="0">本窗口</asp:ListItem>
                      <asp:ListItem Value="1" style="color:#ff0000">新窗口</asp:ListItem>
                    </asp:DropDownList>
                   </td>
                  ...
                  <td align=center width=35% class=tdstyle>
                   ...
                   <a href="link_2.aspx?link1id=<%#DataBinder.Eval(Container.DataItem,"id")%>&target=<%#DataBinder.Eval(Container.DataItem,"target")%>&language=<%#DataBinder.Eval(Container.DataItem,"planguage")%>">明细管理</a>
                    <a href="javascript:link_Js_Code('<%#DataBinder.Eval(Container.DataItem,"id")%>','<%#DataBinder.Eval(Container.DataItem,"target")%>','0','link')">生成JS代码</a>
...
<tr>
  <td valign=top>
    <table border=0 cellpadding=0 cellspacing=2 width=95% align=center>
    <tr><td  colspan=3 height=25><b>增加链接调用</b></td>
    </tr>
      <tr>
        <td  height=25>分类类型：<asp:TextBox      id="Add_type"     maxlength=40 size=20  runat="server" />
