<% @ Page Language="C#" Inherits="PageAdmin.search_1" %>
<% @ Register TagPrefix="aspcn" TagName="uc_head" src="head.ascx" %>
<aspcn:uc_head runat="server" Type="js_3" />
<body topmargin=0 bottommargin=0 leftmargin=0  rightmargin=0>
<center>
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 <tr><td height=10></td></tr>
 <tr><td class=table_style1 align="left"><b>站内搜索调用</b></td></tr>
 <tr><td height=10></td></tr>
</table>
...
<tr>
  <td  colspan=2 height=25  align="left"><b>站内搜索调用管理</b></td>
 </tr>
</table>
          ...
          OnItemDataBound="PageAdmin_Data_Bound"    OnDeleteCommand="PageAdmin_Data_Delete" >
             <HeaderTemplate>
                ...
                <tr>
                  ...
                  <td align=center width=20% class=white>搜索类型</td>
                  <td align=center width=20% class=white>目标窗口</td>
                ...
                <tr>
                  ...
                  <td align=center width=20%  class=tdstyle>
                    <asp:DropDownList id="Dl_Style" runat="server">
                      <asp:ListItem Value="0">产品和文章</asp:ListItem>
                      <asp:ListItem Value="1" style="color:#ff0000">产品</asp:ListItem>
                      <asp:ListItem Value="2" style="color:#339900">文章</asp:ListItem>
                    </asp:DropDownList>
                   </td>
               ...
               <td align=center width=20%  class=tdstyle>
                  ...
                  <td align=center width=35% class=tdstyle>
                   ...
                   <asp:Label id="Lb_target" Text='<%#DataBinder.Eval(Container.DataItem,"target")%>' runat="server" visible="false"/>
                    <a href="javascript:slide_Js_Code('<%#DataBinder.Eval(Container.DataItem,"id")%>','0','searchbox')">生成JS代码</a>
...
<tr>
  <td valign=top>
    <table border=0 cellpadding=0 cellspacing=2 width=95% align=center>
    <tr><td  colspan=3 height=25><b>增加站内搜索调用</b></td>
    </tr>
      <tr>
        <td  height=25 align="left">名称：<asp:TextBox      id="Add_Name"    maxlength="45"  size=20  runat="server" />
                     搜索类型：<asp:DropDownList id="Add_Style" runat="server">
                      <asp:ListItem Value="0">产品和文章</asp:ListItem>
                      <asp:ListItem Value="1" style="color:#ff0000">产品</asp:ListItem>
                      <asp:ListItem Value="2" style="color:#339900">文章</asp:ListItem>
                    </asp:DropDownList>
                     搜索结果窗口：<asp:DropDownList id="Add_Target" runat="server">
                      <asp:ListItem Value="0" >本窗口</asp:ListItem>
                      <asp:ListItem Value="1" style="color:#ff0000">新窗口</asp:ListItem>
                    </asp:DropDownList>
