<% @ Page Language="C#" Inherits="PageAdmin.information_2"%>
...
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 ...
 <tr><td class=table_style1><b>增加文章</b></td></tr>
 <tr><td height=10></td></tr>
</table>
...
<input type="hidden" id="Sort_1_text" name="Sort_1_text"><input type="hidden" id="Sort_2_text" name="Sort_2_text">
      ...
      <tr>
          ...
          <td><input type="textbox"  Name="TBtitle" id="TBtitle" Maxlength="100"  size=80>
        </td>
      </tr>

      <tr>
          <td width=100px height=25 >标题样式</td>
          <td><input type="textbox"  name="TBtitlestyle" id="TBtitlestyle" Maxlength="100"  size=30><a href="javascript:foreColor('TBtitlestyle','color:')"><img src=images/color.gif border=0 height=21 align=absbottom></a>
        </td>
      </tr>

      <tr>
          <td width=100px height=25 >作者</td>
          <td><input type="textbox" name="TBAuthor" id="TBAuthor"  Maxlength="100"  size=30>
...
【<span  onclick="document.getElementById('TBAuthor').value=this.innerHTML" style="cursor:pointer;color:#666666">不详</span>】
      ...
      <tr>
          ...
          <td><input type="textbox" name="TBSource" id="TBSource" Maxlength="100"  size=30>
...
【<span  onclick="document.getElementById('TBSource').value=this.innerHTML" style="cursor:pointer;color:#666666">集团</span>】
      ...
      <tr>
          ...
          <td><input type="textbox" name="TBurl" Maxlength="100"  size=50>
        </td>
      </tr>
  ...
  <select name="Dl_Watermark" id="Watermark">
   ...
   </select><input type="file" name="UploadFile"  size=40></td>
      </tr>


   <tr>
          <td  height=25>SEO标题</td>
          <td><input  type="text" name="TBHeadTitle" Maxlength="100"  size=80>
        </td>
      </tr>
      ...
      <tr>
          ...
          <td><input  type="text" name="TBkeywords" Maxlength="100"  size=80 >
        </td>
      </tr>
      <tr>
          <td height=25>SEO描述</td>
          <td><textarea name="TBdescription" Cols="65"  rows="5" onkeyup="if(this.value.length>250){this.value=this.value.substring(0,250)}"></textarea>
        </td>
      </tr>
      ...
      <tr>
          ...
          <td style="color:#339900"><input type="textbox" name="TBdownload" Maxlength=100 size=50>&nbsp;&nbsp;文件备注 <input type="textbox" name="TBdownload_beizhu" Maxlength=50 size=30></td>
      </tr>

<tr>
  <td  height=25>其他设置</td>
  <td>
  <select name="Dl_Show_Style">
     <option  value="">==文章样式设置==</option>
     <option  value="0">普通样式</option>
     <option  value="1">图文样式</option>
     </select>
   <select name="Dl_Comments_Style">
     ...
     <option value="2">评论开启(直接显示)</option>
      ...
      <tr>
          <td>简介</td>
          <td>
<Textarea type="textbox" id="TBIntro" name="TBIntro" ></Textarea>
...
FCKeditor.ReplaceTextarea(); 
      ...
      <tr>
          <td>内容</td>
          <td>
<Textarea type="textbox" id="Content" name="Content" ></Textarea>
<script type="text/javascript" src="/incs/fckeditor/fckeditor.js"></script>
<script  type="text/javascript"> 
...
<input type="button" value=" 返 回 "    class="button" onclick="location.href='information_1.aspx'"/>
</td>
      <tr>       
    </table>
 </td>
