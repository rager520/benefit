<% @ Page language="c#" Inherits="PageAdmin.orderview" %>
<html>
<head>
<title>订单查看</title>
...
收款状态：<asp:Label id="PayState" runat="server"  forecolor="#ff0000" />&nbsp;
发货状态：<asp:Label id="SendState" runat="server" forecolor="#ff0000" />&nbsp;
操作员：<asp:Label id="ChargeName" runat="server" />
</td>
   ...
   <HeaderTemplate>
     <table border=0 cellpadding=5 cellspacing=1 width=95% align=center bgcolor="#cccccc">
      <tr>
         ...
         <td width=25% align=center class="table_style">产品名称</td>
         <td width=15% align=center class="table_style">产品型号</td>
         <td width=10% align=center class="table_style">标价</td>
         <td width=10% align=center class="table_style">会员价格</td>
         <td width=10% align=center class="table_style">订购数量</td>
         <td width=12% align=center class="table_style">总计</td>
         <td width=13% align=center class="table_style">产品状态</td>
        </tr>
   </HeaderTemplate>
   <ItemTemplate>  
        <tr bgcolor="#ffffff">
         <td height=25 width=5% align=center class="table_style"><%#GetXuhao()%></td>
         <td width=25%  class="table_style"><%#DataBinder.Eval(Container.DataItem,"pdname")%></td>
         <td width=15% class="table_style"><%#DataBinder.Eval(Container.DataItem,"pdxinghao")%></td>
         <td width=10% class="table_style"  align=center><asp:Label Id="Price" Text='<%#DataBinder.Eval(Container.DataItem,"price")%>' runat="server" /></td>
         <td width=10% class="table_style"  align=center><asp:Label Id="MPrice" Text='<%#DataBinder.Eval(Container.DataItem,"mprice")%>' runat="server" /></td>
         <td width=10% class="table_style"  align=center><%#DataBinder.Eval(Container.DataItem,"pdnumber")%></td>
         <td width=12% class="table_style"  align=center><%#DataBinder.Eval(Container.DataItem,"tongji")%></td>
         <td width=13% class="table_style"  align=center><%#Get_State((DataBinder.Eval(Container.DataItem,"state")).ToString())%></td>
        </tr>
      </ItemTemplate> 

</asp:Repeater>
      <tr>
         <td height=20 width=80% class="table_style" colspan="8"><b>产品总价：</b><span style="color:#ff0000;font-weight:bold"><asp:Label Id="LblPdtongji" runat="server"/>元</span></td>
       </tr>
      <tr>
         <td height=20 width=80% class="table_style" colspan="8"><b>配送费用：</b><span style="color:#ff0000;font-weight:bold"><asp:Label Id="LblSendExpense" runat="server"/>元</span></td>
       </tr>
      <tr>
         <td height=20 width=80% class="table_style" colspan="8"><b>总计：</b><span style="color:#ff0000;font-weight:bold"><asp:Label Id="LblTongji" runat="server"/>元</span></td>
       </tr>
</table>
<br>
<table border=0 cellpadding=5 cellspacing=1 width=95% align=center bgcolor=#cccccc>
